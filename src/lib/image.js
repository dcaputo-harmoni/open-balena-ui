...
export function useDeleteImage () {
    ...
    return async (image) => {
        let relatedIndirectLookups = [
            { remoteResource: "image environment variable", remoteField: "release image", viaRemoteField: "id", viaResource: "image-is part of-release", viaLocalField: "image", localField: "id"},
            { remoteResource: "image label", remoteField: "release image", viaRemoteField: "id", viaResource: "image-is part of-release", viaLocalField: "image", localField: "id"},
        ];
