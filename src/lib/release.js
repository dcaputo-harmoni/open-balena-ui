...
export function useDeleteRelease () {
    ...
    return async (release) => {
        let relatedIndirectLookups = [
            { remoteResource: "image", remoteField: "id", viaRemoteField: 'image', viaResource: "image-is part of-release", viaLocalField: "is part of-release", localField: "id", deleteFunction: deleteImage},
        ];
